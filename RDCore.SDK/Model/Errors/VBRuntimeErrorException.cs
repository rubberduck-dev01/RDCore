...
namespace RDCore.SDK.Model.Errors
{
        ...
        : VBErrorInfo((int)VBCompileErrorId, Location, Description, Verbose)
    {
        ...
        /// <summary>
        /// Gets a <see cref="VBCompileErrorInfo"/> encapsulating the compile-time error metadata for a <em>type mismatch</em> error.
        /// </summary>
        /// <param name="location">The document location of the error.</param>
        /// <param name="verbose">A verbose message describing error details.</param>
        public static VBCompileErrorInfo TypeMismatch(Location location, string verbose) => new(VBCompileErrorId.TypeMismatch, location, "Type mismatch", verbose);
/*
