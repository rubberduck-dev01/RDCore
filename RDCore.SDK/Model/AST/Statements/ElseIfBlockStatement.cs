...
public record class ElseIfBlockStatement(Uri SemanticId, SourceLocation SourceLocation, ExpressionNode Condition, StatementBlock ConditionalBlock)
    : StatementNode(SemanticId, SourceLocation, Tokens.ElseIf, [Condition]);
