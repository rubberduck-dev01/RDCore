...
public record class CallStatement(Uri SemanticId, SourceLocation SourceLocation, string Token, ImmutableArray<ExpressionNode> Inputs)
    : StatementNode(SemanticId, SourceLocation, Token, Inputs);
