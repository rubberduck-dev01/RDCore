...
public record class ForStatement(Uri SemanticId, SourceLocation SourceLocation, ExpressionNode ControlExpression, ExpressionNode StartExpression, ExpressionNode EndExpression, ExpressionNode StepExpression, StatementBlock Body)
    : StatementNode(SemanticId, SourceLocation, $"{Tokens.For}-{Tokens.Next}", [ControlExpression, StartExpression, EndExpression, StepExpression]);
