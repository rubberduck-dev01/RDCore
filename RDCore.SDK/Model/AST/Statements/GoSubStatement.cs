...
public record class GoSubStatement(Uri SemanticId, SourceLocation SourceLocation, ExpressionNode LabelExpression)
    : StatementNode(SemanticId, SourceLocation, $"{Tokens.GoSub}", [LabelExpression]);
