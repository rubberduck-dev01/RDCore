...
public record class GoSubStatement(Guid Identity, SourceLocation SourceLocation, ExpressionNode LabelExpression)
    : StatementNode(Identity, SourceLocation, $"{Tokens.GoSub}", [LabelExpression]);
