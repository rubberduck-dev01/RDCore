...
public record class ForEachStatement(Guid Identity, SourceLocation SourceLocation, ExpressionNode ControlExpression, ExpressionNode CollectionExpression, StatementBlock Body)
    : StatementNode(Identity, SourceLocation, $"{Tokens.ForEach}-{Tokens.Next}", [ControlExpression, CollectionExpression]);
