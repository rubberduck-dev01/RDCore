...
public record class IfBlockStatementNode(SyntaxNodeId Identity, SourceLocation SourceLocation, ExpressionNode Condition, StatementBlock ConditionalBlock, ImmutableArray<ElseIfBlockStatementNode>? ElseIfBlocks = default, StatementBlock? ElseBlock = default)
...
/// <param name="ElseIfBlocks">The <c>Else</c> conditional blocks, if any. <strong>Optional</strong></param>
/// <param name="ElseBlock">A block of <em>executable nodes</em> that is executed if the <em>Condition</em> expression evaluates to <c>False</c>. <strong>Optional</strong></param>
public record class PrecompilerIfBlockStatementNode(SyntaxNodeId Identity, SourceLocation SourceLocation, ExpressionNode Condition, StatementBlock ConditionalBlock, ImmutableArray<PrecompilerElseIfBlockStatementNode>? ElseIfBlocks = default, StatementBlock? ElseBlock = default)
    : StatementNode(Identity, SourceLocation, [Condition]);
