...
/// </summary>
/// <param name="Identity">A semantic <c>Uri</c> uniquely identifying this specific node.</param>
...
/// </remarks>
public record DoWhileLoopStatement(Guid Identity, SourceLocation SourceLocation, ExpressionNode ConditionExpression, StatementBlock Body)
    : StatementNode(Identity, SourceLocation, $"{Tokens.While}-{Tokens.Loop}", [ConditionExpression]);
