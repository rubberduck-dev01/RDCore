...
/// </remarks>
public record DoWhileLoopStatement(Uri SemanticId, SourceLocation SourceLocation, ExpressionNode ConditionExpression, StatementBlock Body)
    : StatementNode(SemanticId, SourceLocation, $"{Tokens.While}-{Tokens.Loop}", [ConditionExpression]);
