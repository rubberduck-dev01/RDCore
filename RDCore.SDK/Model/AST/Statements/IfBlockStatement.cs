...
public record class IfBlockStatement(Guid Identity, SourceLocation SourceLocation, ExpressionNode Condition, StatementBlock ConditionalBlock, ImmutableArray<ElseIfBlockStatement>? ElseIfBlocks = default, StatementBlock? ElseBlock = default)
