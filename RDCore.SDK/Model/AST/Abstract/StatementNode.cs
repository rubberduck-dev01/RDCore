...
public abstract record class StatementNode(Uri SemanticId, SourceLocation SourceLocation, string Token, ImmutableArray<ExpressionNode> Inputs)
    : SyntaxNode(SemanticId, SourceLocation, [.. Inputs.Cast<SyntaxNode>()]), IExecutableNode;
