...
{
    public static int BitnessAwarePtrSize => sizeof(Int32);
    ...
    private static readonly Lazy<VBLongPtrValue> _minValue = new(() 
        => new VBLongPtrValue(Int32.MinValue), LazyThreadSafetyMode.PublicationOnly);
    /// <summary>
    ...
    private static readonly Lazy<VBLongPtrValue> _maxValue = new(() 
        => new VBLongPtrValue(Int32.MaxValue), LazyThreadSafetyMode.PublicationOnly);
    /// <summary>
    ...
    private static readonly Lazy<VBLongPtrValue> _zero = new(() 
        => new VBLongPtrValue(0), LazyThreadSafetyMode.PublicationOnly);
    /// <summary>
