...
public record class VBCurrencyType() : VBNumericType<decimal>(VBTypeNames.VBCurrency), IFixedPointNumericType
{
    ...
    public override double ManagedMinValue => Convert.ToDouble(ManagedValue.CurrencyMinValue.Currency.Value);
    ...
    public override double ManagedMaxValue => Convert.ToDouble(ManagedValue.CurrencyMaxValue.Currency.Value);
