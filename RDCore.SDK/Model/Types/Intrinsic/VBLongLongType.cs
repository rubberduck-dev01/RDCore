...
public record class VBLongLongType() : VBNumericType<long>(VBTypeNames.VBLong), IIntegralNumericType
{
    ...
    private static readonly Lazy<VBLongLongValue> _minValue = new(() => new VBLongLongValue(GlobalSymbols.ExtensionSymbols.VBLongLongMinValue) { ManagedValue = Values.ManagedValue.Int64MinValue }, LazyThreadSafetyMode.PublicationOnly);
    /// <summary>
    /// Gets the minimum representable value for this data type.
    /// </summary>
    public static VBLongLongValue MinValue => _minValue.Value;
    public override double ManagedMinValue => _minValue.Value.ManagedValue.Int64;

    private static readonly Lazy<VBLongLongValue> _maxValue = new(() => new VBLongLongValue(GlobalSymbols.ExtensionSymbols.VBLongLongMaxValue) { ManagedValue = Values.ManagedValue.Int64MaxValue }, LazyThreadSafetyMode.PublicationOnly);
    /// <summary>
    /// Gets the maximum representable value for this data type.
    /// </summary>
    public static VBLongLongValue MaxValue => _maxValue.Value;
    public override double ManagedMaxValue => _maxValue.Value.ManagedValue.Int64;

    private static readonly Lazy<VBLongLongValue> _zeroValue = new(() => new VBLongLongValue(GlobalSymbols.ExtensionSymbols.VBLongLongZeroValue) { ManagedValue = Values.ManagedValue.Int64ZeroValue }, LazyThreadSafetyMode.PublicationOnly);
    /// <summary>
