...
public sealed class ExponentOperatorStaticSemanticsTests : BinaryOperatorStaticSemanticsTests
{
    ...
    protected sealed override StaticSemantics Semantics => new BinaryExponentOperatorStaticSemantics();
    ...
    public static IEnumerable<object[]> GetBinaryOperatorTypeMap()
        => StaticSemanticsVBTypeMap.OverrideBinaryOperatorMap(
            ...
            (VBSingleType.TypeInfo, VBByteType.TypeInfo, VBDoubleType.TypeInfo),
            (VBSingleType.TypeInfo, VBIntegerType.TypeInfo, VBDoubleType.TypeInfo),
            (VBByteType.TypeInfo, VBSingleType.TypeInfo, VBDoubleType.TypeInfo),
            (VBIntegerType.TypeInfo, VBSingleType.TypeInfo, VBDoubleType.TypeInfo),
