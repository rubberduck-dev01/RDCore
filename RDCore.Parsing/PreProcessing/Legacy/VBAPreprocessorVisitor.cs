...
internal static class VBALibrary
{
...
internal sealed class SymbolTable<TKey, TValue> where TKey : notnull
{
...
internal sealed class VBAPreprocessorVisitor : VBAConditionalCompilationParserBaseVisitor<IExpression>
{
    ...
    {
        ArgumentNullException.ThrowIfNull(predefinedConstants);
    ...
    private IExpression Visit(VBAConditionalCompilationParser.LiteralContext context)
    {
        ...
        throw new InvalidOperationException(string.Format("Unexpected literal encountered: {0}", context.GetText(_stream)));
    }
